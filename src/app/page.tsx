        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow flex flex-col">
              ...
              <p className="text-gray-600 mb-4">
                Vänskapsappen för kvinnor som vill träffas på riktigt. Upptäck kvinnor
                i din närhet — i listan eller på kartan — följ med på aktiviteter som fika,
                promenader och träning, eller skapa en egen träff. Helt gratis.
              </p>
              <div className="flex items-center gap-4 mb-4">
                <a
              ...
              <div className="mt-auto">
                <StoreBadges ios={APP_LINKS.nara.ios} android={APP_LINKS.nara.android} />
              </div>
            </div>
          </div>
        </div>
